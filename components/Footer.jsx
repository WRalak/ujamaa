    ...
    const linkSections = [
        {
            title: "CATEGORIES",
            links: [
                { text: "Electronics", path: '/shop?category=electronics', icon: null },
                { text: "Clothing & Fashion", path: '/shop?category=clothing', icon: null },
                { text: "Food & Beverages", path: '/shop?category=food', icon: null },
                { text: "Agriculture", path: '/shop?category=agriculture', icon: null },
                { text: "Beauty & Care", path: '/shop?category=beauty', icon: null },
                { text: "Home & Garden", path: '/shop?category=home', icon: null },
            ]
        },
        {
            title: "ABOUT",
            links: [
                ...
                { text: "Become Seller", path: '/create-store', icon: null },
        ...
        },
        {
            ...
            links: [
                ...
                { text: "info@sokomtaani.co.ke", path: 'mailto:info@sokomtaani.co.ke', icon: MailIcon },
                { text: "Nairobi, Kenya", path: '#', icon: MapPinIcon }
            ]
        }
    ];
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">Soko</span>Mtaani<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Your trusted East African marketplace connecting local sellers with quality buyers. Shop from authentic Kenyan products with secure M-Pesa payments and fast delivery across East Africa.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 SokoMtaani All Right Reserved. Serving Kenya, Tanzania, Uganda, Rwanda & Burundi.
                </p>
            </div>
        </footer>
    );
